...
const OrdersList = ({ dateFilter: dateFilterProp, statusFilter: statusFilterProp, designerFilter: designerFilterProp, orderIdToOpen, onOrderOpened }) => {
  ...
  const [orderSourceFilter, setOrderSourceFilter] = useState("all"); // مصدر الطلب: 1–6 (ORDER_SOURCE)
  ...
  const fetchOrders = useCallback(async () => {
      try {
        ...
        // فلتر حسب المصدر — orderSource من الـ API (1–6)
  ...
  return (
    <Paper elevation={3} sx={{ padding: 4, borderRadius: 3 }}>
            ...
            <Table sx={{ minWidth: isMobile ? 800 : undefined }}>
              <TableHead>
                <TableRow sx={{ backgroundColor: "#f5f5f5" }}>
                  ...
                  <TableCell sx={{ fontWeight: 700 }} align="center">المصدر</TableCell>
      ...
      <OrderDetailsDialog
        ...
        getStatusChipColor={getStatusColor}
          ...
          <>
            ...
            <Box sx={{ mt: 1, display: "flex", justifyContent: "center" }}>
              <Button
                ...
                startIcon={<Note />}
                onClick={() => {
                  handleNotesClick(selectedOrder);
                  handleCloseDialog();
                }}
                sx={{ minWidth: 200 }}
              >
